$(function () {
    var tbl = $("#tblDoctor").DataTable({
        ...
        "columns": [
            ...
            {"data": "name", "targets": "1", "orderable": true, "searchable": true, "width": "45%", "render": function (field, type, row, meta) {
                    return field;
                }},
            {"data": "phone1", "targets": "2", "orderable": true, "searchable": true, "width": "10%", "render": function (field, type, row, meta) {
                    return field;
                }},
            {"data": "speciality", "targets": "3", "orderable": true, "searchable": false, "width": "15%", "render": function (field, type, row, meta) {
                    return field;
                }},
            {"data": "place", "targets": "4", "orderable": true, "searchable": false, "width": "15%", "render": function (field, type, row, meta) {
                    return field;
                }},
            {"data": "category", "targets": "5", "orderable": true, "searchable": false, "width": "10%", "render": function (field, type, row, meta) {
                    return field;
                }},
            {"data": "remark", "targets": "5", "orderable": true, "searchable": false, "width": "10%", "render": function (field, type, row, meta) {
                    return field;
                }}
        ],
        "order": [[1, "asc"]],
